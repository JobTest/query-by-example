...
//    }
//
////    public List<Client> findClientsByRegistrationDateBetweenAndIdentificationDateBetweenAndLastLoginDateBetween(Date fromRegistrationDate,
////                                                                                                                Date toRegistrationDate,
////                                                                                                                Date fromIdentificationDate,
////                                                                                                                Date toIdentificationDate,
////                                                                                                                Date fromLastLoginDate,
////                                                                                                                Date toLastLoginDate) {
////        return repository.findClientsByRegistrationDateBetweenAndIdentificationDateBetweenAndLastLoginDateBetween(fromRegistrationDate,
////                toRegistrationDate,
...
////    }
//
//    public List<Client> findClientsByRegistrationDate(Date registrationDate) {
//        return repository.findClientsByRegistrationDate(registrationDate);
//    }
//
