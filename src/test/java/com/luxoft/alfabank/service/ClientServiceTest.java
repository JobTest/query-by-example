...
//import com.luxoft.alfabank.service.ClientService;
...
//                .findClientsByRegistrationDate(null); //.findClientsByRegistrationDate(ConvertUtil.toDate("2017-06-16 10:56:27"));
...
//
//        System.err.println("--------------------------------");
//        List<Client> findClientsByRegistrationDateBetween = repository
//                .findClientsByRegistrationDateBetween(ConvertUtil.toDate("2015-02-03 11:02:17"),
//                        ConvertUtil.toDate("2015-09-22 12:47:31"));
////        findClientsByRegistrationDateBetween.forEach(System.err::println);
//        System.err.println("findClientsByRegistrationDateBetween = " + findClientsByRegistrationDateBetween.size());
//
//        System.err.println("--------------------------------");
